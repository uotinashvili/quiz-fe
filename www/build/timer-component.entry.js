...
let TimerComponent = class {
  ...
  setTimer() {
    timer(0, 1000)
      .pipe(take(this.counter), takeUntil(this.destroy$), tap(() => this.countDown(--this.counter)))
      .subscribe();
  }
  countDown(remaining) {
    if (remaining === 0) {
  ...
  render() {
    return (h("div", null, "Timer: ", h("span", { class: "badge bg-secondary" }, this.counter)));
  }
};
TimerComponent.style = timerCss;
